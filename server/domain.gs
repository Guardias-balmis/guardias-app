...
function compareISO(a, b) {
  ...
  return { parseISO, toISO, weekday, isWeekend, addDays, addYears, daysInMonth, datesOfMonth, academicYearOf, trimesterOf, trimesterWindow, isHoliday, bridgesOfMonth, bridgesBetween, compareISO };
})();
