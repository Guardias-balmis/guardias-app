...
- [ ] Ni `eventos` ni `festivos` tienen pantalla de carga: las dos tablas se rellenan llamando a la acción (`crearEvento`, `crearFestivos`), no desde la app. Mientras siga así, INV-10 e INV-12 están en vigor pero sin datos que comprobar salvo que alguien los cargue por fuera — es la misma laguna que arrastra `festivos` desde V-17
