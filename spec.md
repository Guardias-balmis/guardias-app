...
| INV-3 | **Cierre anual** (año de residencia): dif ≤ 1 con cada compañero del mismo año en total, findes, festivos, **prefestivos**, puentes libres y dobletes V-D. **Cierre trimestral** (ago/nov/feb/may): dif ≤ 1 solo en **total** | año personal · trimestre | error (cierre anual); **aviso** (cierre trimestral, decisión V-13) | ✅ (prefestivos tras la puerta de consistencia; cierre trimestral en P-8) |
...
que operan las Fases 6 y 7 — decidir antes de seguir construyendo encima. **Queda solo P-7**: P-8
está implementada (Fase 7.2, decisión V-13) con la lectura literal de su frase de p.2 — un solo eje
(`total`) y severidad aviso; ahí se decidió además conectar al flujo el cierre anual, que llevaba
desde la Fase 3 implementado sin que lo invocara nadie.
