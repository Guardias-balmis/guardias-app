...
| INV-4 | 3P/cedidas/compradas fuera del cómputo | contaje | — (no emite violación: se aplica excluyendo en `tally`) | ✅ (vía `tally`) |
...
| INV-8 | 3P: cubrir L→D antes de repetir día (por voluntario); dif ≤ 1 entre voluntarios al cierre; prioridad a días con R1 de mochila | año | error (repetición, no-voluntario); **aviso** (equidad al cierre —V-14—, prioridad mochila) | ✅ |
